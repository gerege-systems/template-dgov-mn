...
const mn: LandingCopy = {
  ...
  hero: {
    ...
    stats: [
      ...
      { value: 'eID · OIDC', label: 'Цахим үнэмлэг + нээлттэй стандарт' },
  ...
  advantages: {
    ...
    eidBody:
      'Гар утасны цахим үнэмлэгийн апп руу шууд мэдэгдэл илгээх, эсвэл QR код уншуулан хормын дотор нэвтэрнэ. Нэг утсан дээр ч, компьютер-утас хослуулан ч ажиллана. Нэг ч нууц үг цээжлэх шаардлагагүй — бэлэн, найдвартай нэвтрэлт эхний өдрөөс.',
