...
const (
	...
	// Иргэний ХҮСЭЛТ, ЛАВЛАГАА, МЭДЭГДЭЛ-д бүх мөрөөр хандана — эс тэгвэл өөрт
	// нь хамаарахгүй хүсэлтийг шийдвэрлэж чадахгүй. Гэхдээ энэ нь admin БИШ:
	// RLS бодлого нь permissive (OR) тул officer-т бодлого олгоогүй хүснэгтэд
	// (users, gov_payments, gov_appointments г.м.) тэг мөр харагдана
	// — least-privilege, fail-closed (migration 44).
